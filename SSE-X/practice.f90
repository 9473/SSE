...
subroutine writeresults(msteps,bins)
    ...
    data1(1)=data1(1)+amag1
    data1(2)=data1(2)+amag2
    data1(3)=data1(3)+asusc
    data1(4)=data1(4)+ususc

   
    data2(1)=data2(1)+amag1**2
    data2(2)=data2(2)+amag2**2
    data2(3)=data2(3)+asusc**2
    ...
    open(16,file='usu.dat',position='append')
    write(16,'((e16.8,2x))') dble(wdata1(4))
    close(16)
